...
[[Click here to read the blog!]{.underline}](https://shaggycamel-indiablog24.netlify.app/blog.html) - Alternatively, click "**Travel Blog**" in the top right hand corner 🤚. This summary page can be returned to by clicking "**Journey Summary**" in the top left hard corner ✋. Best viewing is on larger screens, such as a tablet, laptop or computer.
...
destinations <- list(
  ...
  "Karghil" = list(transport="car", point_colour="black"),
